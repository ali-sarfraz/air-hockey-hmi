...
{
    parentPlayerAPtr->setName(tempPlayerAPtr->getName());//works
    parentPlayerBPtr->setName(tempPlayerBPtr->getName());//works
    parentPlayerAPtr->setpType(tempPlayerAPtr->getType());//works now
    parentPlayerBPtr->setpType(tempPlayerBPtr->getType());

    //set text name to curretn naem somehow?
//    ui->label_playerAname->setText(parentPlayerAPtr->getName());
//    ui->label_playerBname->setText(parentPlayerBPtr->getName());

    //edit out when done
    qDebug () << QString::fromStdString ((parentPlayerAPtr->getName()));
    qDebug () << QString::fromStdString ((parentPlayerBPtr->getName()));
    qDebug () << QString::fromStdString (std::to_string(tempPlayerAPtr->getType()));
    qDebug () << QString::fromStdString (std::to_string(tempPlayerBPtr->getType()));
    qDebug () << QString::fromStdString (std::to_string(parentPlayerAPtr->getType()));
    qDebug () << QString::fromStdString (std::to_string(parentPlayerBPtr->getType()));
}
